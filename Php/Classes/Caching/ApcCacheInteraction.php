 ...
 * @license GPLv3
 */
class ApcCacheInteraction extends CachingInteractionAbstract implements CachingInterface
{
    /**
     ...
     * @return mixed - Returns true if the key exists,
     *      otherwise false or if an array was passed to keys, then an array
     ...
     * @return bool - The stored variable or array of variables on
     ...
     *
     * @param string $type - If $type is "user", the user cache will be
     *      cleared; otherwise, the system cache (cached files) will be cleared.
     * @return bool - Returns true on success or false on failure.
     * @throws \Exception
     */
